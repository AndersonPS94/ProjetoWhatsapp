...
import com.example.whatsappapp.adapters.ConversasAdapter
import com.example.whatsappapp.databinding.FragmentContatosBinding
import com.example.whatsappapp.databinding.FragmentConversasBinding
        ...
        if (idUsuarioRemetente != null) {
            eventoSnapshot = firestore
                ...
                .addSnapshotListener { querySnapshot, erro ->
                    ...
                    if (erro != null) {
                        activity?.exibirMensagem("Erro ao carregar conversas")
                    }
